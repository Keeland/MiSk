...
public class ExprDamageBufferWB extends SimpleExpression<Double>{
	...
	protected Double[] get(Event e) {
	    ...
	    return new Double[] { Double.valueOf((int) border.getDamageBuffer()) };
	}
    ...
    public void change(Event e, String to, Integer delta, Changer.ChangeMode mode) {
		if (mode == ChangeMode.SET)
	        ...
	        tc.getWorldBorder().setDamageBuffer(delta);
	        return;
	}
	@SuppressWarnings("unchecked")
	@Override
