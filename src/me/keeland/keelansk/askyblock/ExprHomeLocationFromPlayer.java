...
public class ExprHomeLocationFromPlayer extends SimpleExpression<Location>{
    ...
    public String toString(Event arg0, boolean arg1) {
        return "return home location from a player";
    }
    ...
    protected Location[] get(Event arg0) {
        ...
        r = ASkyBlockAPI.getInstance().getHomeLocation(play);
