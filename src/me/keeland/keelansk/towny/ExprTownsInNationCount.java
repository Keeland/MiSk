...
public class ExprTownsInNationCount extends SimpleExpression<Integer>{
    ...
    public String toString(Event arg0, boolean arg1) {
        return "return count of towns in nation";
    }
    ...
    protected Integer[] get(Event arg0) {
        ...
        Integer pl = nw.getNumTowns();

        return new Integer[] { pl };
    }
