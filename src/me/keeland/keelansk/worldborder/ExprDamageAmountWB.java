...
public class ExprDamageAmountWB extends SimpleExpression<Double>{
	...
	protected Double[] get(Event e) {
	    ...
	    return new Double[] { Double.valueOf((int) border.getDamageAmount()) };
	}
    ...
    public void change(Event e, String to, Integer delta, Changer.ChangeMode mode) {
		if (mode == ChangeMode.SET)
	        ...
	        tc.getWorldBorder().setDamageAmount(delta);
	        return;
	}
	@SuppressWarnings("unchecked")
	@Override
