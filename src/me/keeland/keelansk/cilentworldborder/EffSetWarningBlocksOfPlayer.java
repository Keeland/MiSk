...
public class EffSetWarningBlocksOfPlayer extends Effect {
	
    private Expression<Integer> warningblocks;
    private Expression<Player> play;

    protected void execute(Event event) {
    	Integer warnb = this.warningblocks.getSingle(event);
    ...
    public boolean init(Expression<?>[] expressions, int i, Kleenean kleenean, SkriptParser.ParseResult parseResult) {
        this.warningblocks = (Expression<Integer>) expressions[0];
